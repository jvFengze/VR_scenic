<template>
  <div style="height: 350px;
    ...
    <div class="form" style="font-size: 28px;" v-if="state === true">
      <el-input class="ys" v-model="ruleForm.account" placeholder="Please input" style="max-width: 300px;">
        <template #suffix>
          <el-icon class="el-input__icon" @click="asd()" v-if="qwe === true">
            <Right />
          </el-icon>
    ...
    <div class="form" style="font-size: 28px;" v-else>
      <el-input class="ym1" v-model="ruleForm.account" placeholder="Please input" style="max-width: 300px;" disabled>
        <template #suffix>
      ...
      <el-input class="ym2" v-model="ruleForm.passWord" placeholder="Please input" style="max-width: 300px;"
        type=password>
        <template #suffix>
          <el-icon class="el-input__icon" @click="submit()">
            <Right />
          </el-icon>
        </template>
      </el-input>
